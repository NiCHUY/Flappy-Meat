...
private slots:
   ...
   void background_origin();
   void background_custom();
   void background_custom_picker();
...
private:
    ...
    QPushButton *backgroundorigin_button;
    QPushButton *custom_background_button;
    QPushButton *custom_background_button_picker;
